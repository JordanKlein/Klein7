...
function loadPoints(points,texture) {
    ...
    points.push(vec4(-1, 2, 0, 1));
    texture.push(vec2(0, 0.166));
    points.push(vec4(-1, 0, 0, 1));
    texture.push(vec2(0, 0));
    points.push(vec4(1, 0, 0, 1));
    texture.push(vec2(0.166, 0));

	points.push(vec4(-1, 2, 0, 1));
    texture.push(vec2(0, 0.166));
    points.push(vec4(1, 2, 0, 1));
    texture.push(vec2(0.166, 0.166));
    points.push(vec4(1, 0, 0, 1));
    texture.push(vec2(0.166, 0));

    points.push(vec4(-1, 6, 0, 1));
    texture.push(vec2(0, 0.166));
    points.push(vec4(-1, 4, 0, 1));
    texture.push(vec2(0, 0));
    points.push(vec4(1, 4, 0, 1));
    texture.push(vec2(0.166, 0));
